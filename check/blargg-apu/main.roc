...
# check/blargg-apu/passlist gate (exit nonzero on regression); unlisted ROMs
...
main! = |args| {
    passlist_bytes = Path.from_os_str(OsStr.from_str("check/blargg-apu/passlist")).read_bytes!() ?? []
