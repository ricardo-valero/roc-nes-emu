...
Lookup cycle : [
    ADC [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    AND [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    ASL [Absolute [Base, X], Implied, ZeroPage [Base, X]] cycle,
    BCC [Relative] cycle,
    BCS [Relative] cycle,
    BEQ [Relative] cycle,
    BIT [Absolute [Base], ZeroPage [Base]] cycle,
    BMI [Relative] cycle,
    BNE [Relative] cycle,
    BPL [Relative] cycle,
    BRK [Immediate] cycle,
    ...
    CLI [Implied] cycle,
    CLV [Implied] cycle,
    CMP [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    CPX [Absolute [Base], Immediate, ZeroPage [Base]] cycle,
    CPY [Absolute [Base], Immediate, ZeroPage [Base]] cycle,
    DEC [Absolute [Base, X], ZeroPage [Base, X]] cycle,
    DEX [Implied] cycle,
    DEY [Implied] cycle,
    EOR [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    INC [Absolute [Base, X], ZeroPage [Base, X]] cycle,
    INX [Implied] cycle,
    INY [Implied] cycle,
    JMP [Absolute [Base], Indirect [Base]] cycle,
    JSR [Absolute [Base]] cycle,
    LDA [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    LDX [Absolute [Base, Y], Immediate, ZeroPage [Base, Y]] cycle,
    LDY [Absolute [Base, X], Immediate, ZeroPage [Base, X]] cycle,
    LSR [Absolute [Base, X], Implied, ZeroPage [Base, X]] cycle,
    NOP [Implied] cycle,
    ORA [Absolute [Base, X, Y], Immediate, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    PHA [Implied] cycle,
    PHP [Implied] cycle,
    PLA [Implied] cycle,
    PLP [Implied] cycle,
    ROL [Absolute [Base, X], Implied, ZeroPage [Base, X]] cycle,
    ROR [Absolute [Base, X], Implied, ZeroPage [Base, X]] cycle,
    RTI [Implied] cycle,
    RTS [Implied] cycle,
    SBC [Absolute [Base, X, Y], Immediate, Implied, Indirect [X, Y], ZeroPage [Base, X]] cycle,
    SEC [Implied] cycle,
    SED [Implied] cycle,
    SEI [Implied] cycle,
    STA [Absolute [Base, X, Y], Indirect [X, Y], ZeroPage [Base, X]] cycle,
    STX [Absolute [Base], ZeroPage [Base, Y]] cycle,
    STY [Absolute [Base], ZeroPage [Base, X]] cycle,
    TAX [Implied] cycle,
    TAY [Implied] cycle,
    TSX [Implied] cycle,
    TXA [Implied] cycle,
